...
WINNER_FONT = pygame.font.SysFont('comicsands', 100)
...
def red_movement(keys_pressed, red):
    if keys_pressed[pygame.K_LEFT] and red.x - VEL > BORDER.x + BORDER.width:  # Left
        red.x -= VEL
    if keys_pressed[pygame.K_RIGHT] and red.x + SPACESHIP_WIDTH + VEL < 900:  # Right
        red.x += VEL
    if keys_pressed[pygame.K_UP] and red.y - VEL > 0:  # Up
        red.y -= VEL
    if keys_pressed[pygame.K_DOWN] and red.y + VEL + SPACESHIP_HEIGHT + 10 < HEIGHT:  # Down
        red.y += VEL
